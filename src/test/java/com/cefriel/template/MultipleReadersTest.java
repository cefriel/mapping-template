...
public class MultipleReadersTest {
    ...
    public void testMultipleReaders() throws Exception {
        ...
        TemplateExecutor templateExecutor = new TemplateExecutor(readers, new TemplateFunctions(), true, false, false, null, null);
        String result = templateExecutor.executeMapping(template).replaceAll("\\r\\n", "\n");;
