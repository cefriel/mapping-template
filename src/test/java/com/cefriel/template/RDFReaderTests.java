...
public class RDFReaderTests {
    ...
    public void agencyParametric() throws Exception {
        ...
        Map<String, String> output = executor.executeMappingParametric(template, queryPath);
    ...
    public void agencyParametricStream() throws Exception {
        ...
        TemplateExecutor executor = new TemplateExecutor(reader, new TemplateFunctions(), true, false, false, null, null);
        Map<String, String> output = executor.executeMappingParametric(template, query);
